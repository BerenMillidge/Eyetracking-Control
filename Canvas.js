...
var Canvas = {
  ...
  add : function() {
    ...
    rules = document.createTextNode('html,body{padding:0;margin:0;}#xLabsAppCanvas{pointer-events:none;top:0;left:0;position:fixed;z-index:500;}#xLabsAppCanvas.allow-pointer{pointer-events:none;}');
    style.type = 'text/css';
